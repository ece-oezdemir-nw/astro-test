...
default_args={
    "owner": "matija.milkovic@new-work.se,Open in Cloud IDE",
}

@dag(
    default_args=default_args,
    schedule=None,
    start_date=pendulum.from_format("2025-03-14", "YYYY-MM-DD"),
    catchup=False,
    owner_links={
        "matija.milkovic@new-work.se": "mailto:matija.milkovic@new-work.se",
        "Open in Cloud IDE": "https://cloud.astronomer.io/cm7vpp9790phl01prbv7fjxpq/cloud-ide/cm833k6ig100w01id2fit528c/cm833k6y80zy801efvwblefmt",
    },
)
